...
def search_jobs(keyword=None, location=None, work_mode=None, job_type=None, salary_min=None, salary_max=None):
    """
    ...
    for job in jobs:
        ...
        if salary_min and job.salary_min:
            if job.salary_min < int(salary_min):
                continue

        # Filter by maximum salary
        if salary_max and job.salary_max:
            if job.salary_max > int(salary_max):
                continue
